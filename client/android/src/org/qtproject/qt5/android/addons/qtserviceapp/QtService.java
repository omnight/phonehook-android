...
public class QtService extends Service {
        ...
        if (!started){
            ...
            try{
                ...
                if (m_serviceInfo.metaData.containsKey("android.app.use_local_qt_libs")
                    ...
                    loaderParams.putString(LOADER_CLASS_NAME_KEY, "org.qtproject.qt5.android.QtServiceDelegateX");
    ...
    public void loadApplication(Bundle loaderParams){
        ...
        try{
            ...
            String pluginsPrefix = getApplicationInfo().dataDir + "/qt-reserved-files/";
